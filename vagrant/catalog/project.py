...
def gconnect():
    ...
    print "Verify that the access token is used for the intended user."
    ...
    print "Is current user already connected?"
    ...
    print "see if user exists, if it doesn't make a new one"
...
def showCatalog():
    ...
    latest_items = db_session.query(Item).order_by(desc(Item.id))
